...
class AflStatsTestCase(unittest.TestCase):
    ...
    def test_parse_stat_file(self):
        ...
        self.assertDictEqual(test_complete_stats,
                             afl_stats.parse_stat_file('testdata/sync/fuzz000/fuzzer_stats', summary=False))
    ...
    def test_main_no_twitter(self):
        afl_stats.main(
            ['afl-stats', '--config', './testdata/afl-stats.conf.test2', '--database', 'testdata/afl-stats2.db'])
