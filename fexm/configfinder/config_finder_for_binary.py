...
def main(binary_path: str, timeout: float, seeds_dir: str, cores: int = 8) -> [CliConfig]:
    ...
    print("K:",
          max(zip(best_input_vector.chebyshev_scores[0], best_input_vector.chebyshev_scores[1]), key=lambda x: x[1]))
